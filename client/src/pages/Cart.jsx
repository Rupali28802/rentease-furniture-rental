...
//         <h1 className="md:text-3xl font-bold">My Cart ({cartItems.length})</h1>
//         {cartItems.length > 0 && (
//           <button
//             onClick={clearCart}
...
//               <div
//                 key={item._id}
//                 className="flex flex-col md:flex-row items-start md:items-center bg-white p-4 rounded shadow"
//               >
//                 {/* Image */}
//                 <img
//                   src={item.product.image}
//                   alt={item.product.name}
//                   className="w-full h-40 md:w-24 md:h-24 object-cover rounded mb-4 md:mb-0 md:mr-4"
//                 />
...
//                   {/* Quantity + Remove */}
//                   <div className="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-4 md:ml-auto">
...
//           {/* Cart Summary (30% Sticky) */}
//           <div className="md:col-span-3">
//             <div className="bg-white p-6 rounded shadow-md md:sticky md:top-6 h-fit">
